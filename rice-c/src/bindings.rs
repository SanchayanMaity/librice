...
unsafe extern "C" {
    #[doc = " Enable consent freshness for this `RiceAgent`.\n\n Consent freshness is enabled by default."]
    pub fn rice_agent_enable_consent_freshness(agent: *const RiceAgent);
}
unsafe extern "C" {
    #[doc = " Disable consent freshness for this `RiceAgent`."]
